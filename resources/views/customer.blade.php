                    ...
                    <div class="card m-5">
                        ...
                        <table width="100%" class="table table-bordered table-hover" id="dataTables-example">
                            <thead>
                                ...
                                <td>{{ $data->notelp }}</td>
                                <td>{{ $data->alamat }}</td>
                                <td><a class="btn btn-danger" href="deletecus/{{ $data->id_customer}}"><i class="fas fa-trash-alt"></i></a> <a class="btn btn-warning" href="editcustomer/{{ $data->id_customer}}"><i class="fas fa-edit"></i></a></td>
                                </tr>
                                @endforeach
                            </thead>
                        </table>
                        <a class="btn btn-success" href="/addcus">Tambah Data <i class="fas fa-plus"></i></a>
                        </div>
                        </div>
                    </div>
                </div>
