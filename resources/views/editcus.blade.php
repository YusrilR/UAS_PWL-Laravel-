               ...
               <section id="contact" class="section-bg" style="margin-top: 50px;">
                  <div class="container" data-aos="fade-up">
                    <header class="section-header">
                      <h3 class="section-title">Daftar Edit Customer</h3>
                    </header>

                    <div class="form">
                    @foreach($customer as $data)
                      <form action="/editcus/{id_customer}" method="post" class="php-email-form">
                        @csrf
                        <!-- {{ csrf_field() }} -->
                        <div class="form-group">
                          <label for="id_customer">Id Customer :</label>
                          <input type="text" name="id_customer" class="form-control" id="id_customer" placeholder="Id Customer" value="{{ $data->id_customer}}"/>
                        </div>
                        <div class="form-group">
                          <label for="nama_customer">Nama Customer :</label>
                          <input type="text" class="form-control" name="nama_customer" id="nama_customer" placeholder="Nama Customer" value="{{ $data->nama_customer}}" data-rule="minlen:1"/>
                        </div>
                        <div class="form-group">
                          <label for="notelp">No Telp :</label>
                          <input type="text" class="form-control" name="notelp" id="notelp" placeholder="No Telp" data-rule="minlen:1" value="{{ $data->notelp}}" />
                        </div>
                        <div class="form-group">
