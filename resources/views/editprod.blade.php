        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/daftartransaksibeli">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Daftar Transaksi Restok</span></a>
            </li>  
            <li class="nav-item ">
                <a class="nav-link" href="/daftartransaksijual">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Daftar Transaksi Penjualan</span></a>
            </li>
            <!-- Divider -->
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="bcd/img/undraw_profile_1.svg"
                                            alt="">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="bcd/img/undraw_profile_2.svg"
                                            alt="">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="bcd/img/undraw_profile_3.svg"
                                            alt="">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="bcd/img/undraw_profile.svg">
                            </a>
               ...
               <section id="contact" class="section-bg" style="margin-top: 50px;">
                  <div class="container" data-aos="fade-up">
                    <header class="section-header">
                      <h3 class="section-title">Daftar Edit Produk</h3>
                    </header>

                    <div class="form">
                    @foreach($produk as $data)
                      <form action="/editprod/{id_roti}" method="post" class="php-email-form">
                        @csrf
                        <!-- {{ csrf_field() }} -->
                        <div class="form-group">
                          <label for="id_roti">Id Roti :</label>
                          <input type="text" name="id_roti" class="form-control" id="id_roti" placeholder="Id Roti" value="{{ $data->id_roti}}"/>
                        </div>
                        <div class="form-group">
                          <label for="nama_roti">Nama Roti :</label>
                          <input type="text" class="form-control" name="nama_roti" id="nama_roti" placeholder="Nama Roti" value="{{ $data->nama_roti}}" data-rule="minlen:1"/>
                        </div>
                        <div class="form-group">
                          <label for="stok">Stok :</label>
                          <input type="text" class="form-control" name="stok" id="stok" placeholder="Stok" data-rule="minlen:1" value="{{ $data->stok}}" />
                        </div>
                        <div class="form-group">
                    ...
                    <script>
                        function clearform() {
                        document.getElementById("id_roti").value = "";
                        document.getElementById("nama_roti").value = "";
