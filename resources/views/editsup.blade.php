               ...
               <section id="contact" class="section-bg" style="margin-top: 50px;">
                  <div class="container" data-aos="fade-up">
                    <header class="section-header">
                      <h3 class="section-title">Daftar Edit Supplier</h3>
                    </header>

                    <div class="form">
                    @foreach($supplier as $data)
                      <form action="/editsup/{id_supplier}" method="post" class="php-email-form">
                        @csrf
                        <!-- {{ csrf_field() }} -->
                        <div class="form-group">
                          <label for="id_supplier">Id Supplier :</label>
                          <input type="text" name="id_supplier" class="form-control" id="id_supplier" placeholder="Id Supplier" value="{{ $data->id_supplier }}"/>
                        </div>
                        <div class="form-group">
                          <label for="nama_supplier">Nama Supplier :</label>
                          <input type="text" class="form-control" name="nama_supplier" id="nama_supplier" placeholder="Nama Supplier" value="{{ $data->nama_supplier }}" data-rule="minlen:1"/>
                        </div>
                        <div class="form-group">
