               ...
               <section id="contact" class="section-bg" style="margin-top: 50px;">
                  <div class="container" data-aos="fade-up">
                    <header class="section-header">
                      <h3 class="section-title">Daftar Insert Customer</h3>
                    </header>

                    <div class="form">
                      <form action="/formcustomer/storecustomer" method="post" class="php-email-form">
                        @csrf
                        <!-- {{ csrf_field() }} -->
                        <div class="form-group">
                          <label for="id_customer">Id Customer :</label>
                          <input type="text" name="id_customer" class="form-control" id="id_customer" placeholder="Id Customer"/>
                        </div>
                        <div class="form-group">
