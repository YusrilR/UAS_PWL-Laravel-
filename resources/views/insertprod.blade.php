               ...
               <section id="contact" class="section-bg" style="margin-top: 50px;">
                  <div class="container" data-aos="fade-up">
                    <header class="section-header">
                      <h3 class="section-title">Daftar Insert Produk</h3>
                    </header>

                    <div class="form">
                      <form action="/formproduk/storeproduk" method="post" class="php-email-form">
                        @csrf
                        <!-- {{ csrf_field() }} -->
                        <div class="form-group">
                          <label for="id_roti">Id Roti :</label>
                          <input type="text" name="id_roti" class="form-control" id="id_roti" placeholder="Id Roti"/>
                        </div>
                        <div class="form-group">
                          <label for="nama_roti">Nama Roti :</label>
                          <input type="text" class="form-control" name="nama_roti" id="nama_roti" placeholder="Nama Roti"/>
                        </div>
                        <div class="form-group">
