                    ...
                    <div class="card m-5">
                        ...
                        <table width="100%" class="table table-bordered table-hover" id="dataTables-example">
                            <thead>
                                ...
                                <td>{{ $data->stok}}</td>
                                <td>{{ $data->harga}}</td>
                                <td><a class="btn btn-danger" href="transaksibeli/{{ $data->id_roti}}"><i class="fas fa">Beli</i></a> <a class="btn btn-danger" href="deleteprod/{{ $data->id_roti}}"><i class="fas fa-trash-alt"></i></a> <a class="btn btn-warning" href="editproduk/{{ $data->id_roti}}"><i class="fas fa-edit"></i></a></td>
                                </tr>
                                @endforeach
                            </thead>
                        </table>
                        <a class="btn btn-success" href="/addprod">Tambah Data <i class="fas fa-plus"></i></a>
                        </div>
                        </div>
                    </div>
                </div>
