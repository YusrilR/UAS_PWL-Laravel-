                    ...
                    <div class="card m-5">
                        ...
                        <table width="100%" class="table table-bordered table-hover" id="dataTables-example">
                            <thead>
                                ...
                                <td>{{ $data->notelp }}</td>
                                <td>{{ $data->alamat }}</td>
                                <td><a class="btn btn-danger" href="delete/{{ $data->id_supplier}}"><i class="fas fa-trash-alt"></i></a> <a class="btn btn-warning" href="edit/{{ $data->id_supplier}}"><i class="fas fa-edit"></i></a></td>
                                </tr>
                                @endforeach
                            </thead>
                        </table>
                        <a class="btn btn-success" href="/add">Tambah Data <i class="fas fa-plus"></i></a>
                        </div>
                        </div>
                    </div>
                </div>
